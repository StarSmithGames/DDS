...
{
	public IStat Condtion { get; protected set; }
	...
	public IStat Thrist { get; protected set; }

	//private List<IStat> stats;

	public Stats(StatsSettings settings)
	{
		Condtion = new ConditionStat(settings.condtion, 100f);
		...
		Thrist = new ThirstStat(settings.thrist, 100f);
